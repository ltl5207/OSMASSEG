...
class dataset_ABmixed(Dataset):
    def __init__(self, opt, transform=None, G=None, TU1=None, device=None):
        self.G = G
        self.TU1 = TU1
        #
    ...
    def __getitem__(self, index):
        if self.split == 'train':
            ...
            if domain_flag == 'A':
                ...
                im_aS = F.grid_sample(torch.from_numpy(im_aG).unsqueeze(0).unsqueeze(0), d_field.unsqueeze(0),
